...
const Testimonials: React.FC = () => {
  ...
  <svg
    ...
    height="20"
    viewBox="0 0 22 20"
    fill={filled ? "#FF532E" : "#E5E7EB"} // orange if filled, gray if not
  ...
  {Array.from({ length: 5 }, (_, i) => (
    <Star key={i} filled={i < card.rating} />
  ))}
</div>
    ...
    return (
        ...
        `}</style>
         ...
         <div className="mb-4 mt-24 text-center">
                <h1 className="font-semibold text-4xl">Loved by Creators</h1>
                <p className="text-gray-600 p-3">Join the community of creators who trust our platform to deliver exceptional results.</p>
            </div>
